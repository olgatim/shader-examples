class Sketch {
  ...
  resize() {
    ...
    this.material.uniforms.resolution.value.x = this.width / 2;
    this.material.uniforms.resolution.value.y = this.height / 2;
  ...
  prev() {
    ...
    this.isRunning = true;
    let len = this.textures.length;
    prevStep = (this.current - 1) % len;
    console.log("before: ", this.current);
    let prevTexture = this.textures[prevStep];
